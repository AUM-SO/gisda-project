...
function Trekking() {
  ...
  const fetchCardsData = (query = {}) => {
    console.log("--->", query);
    axios
      .get("https://trekking.gistda.or.th/api/posts", {
        params: query,
  ...
  const fetchCategoriesData = () => {
    axios.get("https://trekking.gistda.or.th/api/categories/").then((data) => {
  ...
  */
  ...
  const showNavbar = () => {
    navRef.current.classList.toggle("filter_container");
  };
    ...
    <>
      <div className="Trekking">
        ...
        <div className="container_trekking">
          <div
            className="filter_container stylefilter"
            ref={navRef} /* style={{ display: toggle ?  'none' : 'block' }} */
          >
            <button
              onClick={showNavbar}
              id="btnfilter"
            ...
            >
              <CgClose className="iconfiter" />
            </button>
            <div className="container_Location">
              <h3 className="style_textfilter">Location</h3>

              {categories
                .filter((c) => c.namespace === "location")
                .map((categories) => (
          ...
          <div className="container_item">
            <div className="titleBox">
              <button onClick={showNavbar} id="btnfilter" className="btnfilter">
                <GoSettings className="iconfiter" />
              </button>
